...
Roundcube Subject Should be visible
    ...
    ...    xpath://span[@class='subject']//span[contains(text(), '${subject}')]
    ...    timeout=4s
...
Roundcube Clear All
    ...
    FOR    ${i}    IN RANGE    999999
        ...
        ...    jquery:table#messagelist>tbody>tr:visible
...
Delete All Mails
    ...
    Wait To Click
    ...    xpath=//a[@title='Folder actions...' and @class='button icon sidebar-menu active' and @data-popup='mailboxoptions-menu' and @id='rcmbtn107' and @role='button' and @href='#' and @aria-haspopup='true' and @aria-expanded='false' and @aria-owns='mailboxoptions-menu' and @data-original-title='Folder actions...']
    Screenshot
    Wait To Click    xpath=//a[text()='Empty']
    Screenshot
    Wait To Click
    ...    xpath=//button[@type='button' and @class='mainaction delete btn btn-primary btn-danger' and text()='Delete']
    Screenshot
